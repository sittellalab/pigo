...
| `pigo/pkg/utils`      | The exposed package utilities.           |
...
Components will ideally be developed with this concept in mind, using no JavaScript unless otherwise required. Any JavaScript should fail gracefully such that the component should be functional without it.
