...
stylesmin:
	npx nodemon -e css -i pkg/themes/pigo.min.css -i pkg/themes/pigo.css \
		-x 'lightningcss --minify --bundle --targets ">=0.25%" pkg/ui/_input.css -o pkg/themes/pigo.min.css'

styles:
	npx nodemon -e css -i pkg/themes/pigo.min.css -i pkg/themes/pigo.css \
		-x 'lightningcss --bundle --targets ">=0.25%" pkg/ui/_input.css -o pkg/themes/pigo.css'
